            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('pers_nr') ? ' has-error' : '' }}">
                            <label for="pers_nr" class="col-md-4 control-label">Personal- / Matrikelnumber</label>

                            <div class="col-md-6">
                                <input id="pers_nr" type="text" class="form-control" name="pers_nr" value="{{ old('pers_nr') }}" required autofocus>

                                @if ($errors->has('pers_nr'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('pers_nr') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
